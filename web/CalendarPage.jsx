function CalendarPage(){
  ...
  const [live,setLive] = useState(null);   // q 命中时的后端检索结果；null=显示全部
  ...
  // mini month
  const today = new Date(2026,5,28); // June=5
        ...
        <div className="lg:col-span-2 glass p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-1">
              <button className="w-7 h-7 rounded-md hover:bg-[var(--bg-elev-2)] text-[var(--text-dim)]"><i className="fas fa-chevron-left text-[11px]"></i></button>
              <button className="w-7 h-7 rounded-md hover:bg-[var(--bg-elev-2)] text-[var(--text-dim)]"><i className="fas fa-chevron-right text-[11px]"></i></button>
            </div>
          </div>
